 ...
 * Have to use an XML writer because in Maven 2.x the PlexusConfig toString() method loses XML
 * attributes
 * Note: This class was originally copied from antrun-plugin. It is duplicated here
